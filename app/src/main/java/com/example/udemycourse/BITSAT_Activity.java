...
public class BITSAT_Activity extends AppCompatActivity implements RecyclerViewInterface {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bitsat);

        RecyclerView bitsatlist = findViewById(R.id.bitsat);
    ...
    public void OnItemClick(int position) {
        if(position==0){
            Toast.makeText(BITSAT_Activity.this, "Coming Soon!!", Toast.LENGTH_SHORT).show();
        }
        if (position==1){
            Intent intent1 = new Intent(BITSAT_Activity.this,bitsatpyq.class);
