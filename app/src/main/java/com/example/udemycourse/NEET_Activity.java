...
public class NEET_Activity extends AppCompatActivity implements RecyclerViewInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView neetlist;
        neetlist = findViewById(R.id.neet);
    ...
    public void OnItemClick(int position) {
        if(position==0){
            Toast.makeText(NEET_Activity.this, "Coming Soon!!", Toast.LENGTH_SHORT).show();
        }
        if (position==1){
            Intent intent1 = new Intent(NEET_Activity.this,NEETpyq.class);
