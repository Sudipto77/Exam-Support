...
public class ISI_Activity extends AppCompatActivity implements RecyclerViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView isilist = findViewById(R.id.isi);
    ...
    public void OnItemClick(int position) {
        if(position==0){
            Toast.makeText(ISI_Activity.this, "Coming Soon!!", Toast.LENGTH_SHORT).show();
        }
        if (position==1){
            Intent intent1 = new Intent(ISI_Activity.this,ISIpyq.class);
