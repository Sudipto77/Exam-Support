...
public class BoardsActivity extends AppCompatActivity implements RecyclerViewInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView boardslist = findViewById(R.id.boards);
    ...
    public void OnItemClick(int position) {
        if(position==0){
            Toast.makeText(BoardsActivity.this, "Coming Soon!!", Toast.LENGTH_SHORT).show();
        }
        if (position==1){
            Intent intent1 = new Intent(BoardsActivity.this,BoardsPYQ.class);
