...
public class JEEMainActivity2 extends AppCompatActivity implements RecyclerViewInterface{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jeemain2);

        RecyclerView jeeresourceslist = findViewById(R.id.recyclerview_jee);
        ...
        jeeresourceslist.setAdapter(adaptor);
    ...
    public void OnItemClick(int position) {
        if(position==0){
            Toast.makeText(JEEMainActivity2.this, "Coming Soon!!", Toast.LENGTH_SHORT).show();
        }
        if (position==1){
            Intent intent1 = new Intent(JEEMainActivity2.this,Jeepyq_Activity.class);
